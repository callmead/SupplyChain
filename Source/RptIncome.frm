...
Begin VB.Form RptIncome 
   Caption         =   ":: INCOME REPORT :."
   ClientHeight    =   6585
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8400
   Icon            =   "RptIncome.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "RptIncome.frx":0BC2
   ScaleHeight     =   6585
   ScaleWidth      =   8400
...
Private Sub Form_Load()
    ...
    report.ReportTitle = "General Income Report"
