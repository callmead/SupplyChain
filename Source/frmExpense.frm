...
Begin VB.Form frmExpense 
   ...
   Begin VB.ComboBox PM 
      ...
      ForeColor       =   &H00404040&
      Height          =   360
      ItemData        =   "frmExpense.frx":C1006
      Left            =   2280
      List            =   "frmExpense.frx":C1013
      Sorted          =   -1  'True
      TabIndex        =   5
      Text            =   "PM"
      Top             =   1200
   ...
   Begin VB.ComboBox ET 
      ...
      ForeColor       =   &H00404040&
      Height          =   360
      ItemData        =   "frmExpense.frx":C1032
      Left            =   2280
      List            =   "frmExpense.frx":C103C
      Sorted          =   -1  'True
      TabIndex        =   3
      Text            =   "ET"
      Top             =   720
   ...
   Begin VB.ComboBox ST 
      ...
      ForeColor       =   &H00404040&
      Height          =   360
      ItemData        =   "frmExpense.frx":C105B
      Left            =   4440
      List            =   "frmExpense.frx":C1071
      Sorted          =   -1  'True
      TabIndex        =   18
      Text            =   "Supplier"
      Top             =   3840
